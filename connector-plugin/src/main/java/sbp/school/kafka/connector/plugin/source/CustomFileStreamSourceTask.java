package sbp.school.kafka.connector.plugin.source;
...
@Slf4j
public class CustomFileStreamSourceTask extends SourceTask {
    ...
    public CustomFileStreamSourceTask() {
        this(1024);
    }

    /* visible for testing */
    CustomFileStreamSourceTask(int initialBufferSize) {
        buffer = new char[initialBufferSize];
    }

    @Override
    public String version() {
        return new CustomFileStreamSourceConnector().version();
    }

    @Override
    public void start(Map<String, String> props) {
        AbstractConfig config = new AbstractConfig(CustomFileStreamSourceConnector.CONFIG_DEF, props);
        filename = config.getString(CustomFileStreamSourceConnector.FILE_CONFIG);
        ...
        topic = config.getString(CustomFileStreamSourceConnector.TOPIC_CONFIG);
        batchSize = config.getInt(CustomFileStreamSourceConnector.TASK_BATCH_SIZE_CONFIG);
    }
